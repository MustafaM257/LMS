...
<div class="container-fluid remove-vid-marg" id="home">
    ...
    <div class="vid-content">
        <h1 class="my-content">Welcome to Learnify</h1>
        <small class="mt-content" style="font-size: 17px">We make the complex simple</small>
        <br>
...
<div class="container-fluid txt-banner" style="background: #8A6FDF">
    <div class="row bottom-banner">
        <div class="col-sm">
            <h5>
                <i class="fas fa-book mr-3"></i> Plenty of Online Courses
            </h5>
        </div>
        <div class="col-sm">
            <h5>
                <i class="fas fa-user mr-3"></i> Professional Instructors
            </h5>
        </div>
        <div class="col-sm">
            <h5>
...
<div class="container mt-5">
    ...
    <div class="text-center m-2">
        ...
        <!-- The view all courses will redirect to the page courses.php to query them all and display -->
    </div>
</div>
    ...
    <div class="container">
        <div class="row text-center">
            <div class="col-md-4">
                ...
                <p>
                    Learnify is a leading e-learning platform offering universal access to top university and organization courses online. Join us for high-quality, interactive and engaging education experiences from the comfort of your own home.
                </p>
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                ...
                <p>
                    Emails:<br>
                    <a href="mailto:mustafa.almuhammad@st.ul.edu.lb">mustafa.almuhammad@st.ul.edu.lb</a>
                    <hr />
                    <a href="mailto:amal.darweesh@st.ul.edu.lb">amal.darweesh@st.ul.edu.lb</a>
                </p>
            </div>
        </div>
    </div>
